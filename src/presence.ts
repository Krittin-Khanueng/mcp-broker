...
export function updateHeartbeat(db: Database.Database, agentId: string): void {
...
export function autoHeartbeat(db: Database.Database): void {
...
export function pruneStaleAgents(db: Database.Database, pruneAfterDays: number): number {
